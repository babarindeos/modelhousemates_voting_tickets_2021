    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 page_header_spacer">
                <h3>Personnels (<?php echo $number_of_users; ?>)</h3>
            </div>
                  ...
                  <tbody id='tblBody'>
                      <?php
                          ...
                          foreach($get_users as $row){
                              ...
                              // Button cell view
                              $mask = mask($user_id);
                              $user_view_link = "user_form_view.php?q={$mask}";
                             ...
                             // Button cell edit
                             $mask = mask($user_id);
                             $user_edit_link = "user_form_grade.php?en={$mask}";
                             $btn_user_edit = "<a href='{$user_edit_link}'
                              ...
                              echo "<td width='5%'>{$counter}.</td><td>{$file_no}</td>
                                    ...
                                    <td align='center'>{$btn_user_view} {$btn_user_edit}</td>";
                              echo "</tr>";
