...
<div class="container">
    ...
    <div class="row rounded border px-2 py-5 mt-5 ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 py-1 text-center">
             <h2><span style='color:gold;'>Congratulations!!!</span><br/> Your Ticket has been successfully paid for<br/>
               <small>Ticket reference number is <?php  echo $_GET_URL_reference; ?> </small></h2>
               <br/>
               <h3>Your Passcode: <?php echo $passcode; ?> </h3>
               <small>Keep the details of this page, it will be required at the Venue of the Event</small>
        </div>
