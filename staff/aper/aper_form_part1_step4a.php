<div class="row border rounded">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 py-4">
        <h4>Step 4A -  Medical Leave</h4>
        (Total number of days absent on sick leave during the period covered by the Report)
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <form>
                ...
                <div class="form-group row">
                        <label for="medical_leave_type" class="col-xs-12 col-sm-12 col-md-12 col-lg-2 col-form-label text-lg-right">Medical Leave</label>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">                                
                                    <select class="browser-default custom-select custom-select-md" id="medical_leave_type" >
                                        <option></option>
                                        <option>Hospitalization</option>
                                        <option>Treatment Received Abroad</option>
