              ...
              <form>
                ...
                <div class="row mt-4 rounded border py-3 text-center">
                    <div class="col-xs-12 col-sm-12 col-lg-12">
                              ...
                              <!-- Votes 100-->
                              <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input vote_option" id="votes_100" name="votes_count" value="100">
                              <label class="custom-control-label" for="votes_100">100 Votes</label>
                              </div>

                              <!-- Votes 300-->
                              <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input vote_option" id="votes_300" name="votes_count" value="300">
                              <label class="custom-control-label" for="votes_300">300 Votes</label>
                              </div>


                               <!-- Votes 500-->
                              <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input vote_option" id="votes_500" name="votes_count" value="500">
                              <label class="custom-control-label" for="votes_500">500 Votes</label>
                              </div>

                              <!-- Votes 1000-->
                              <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input vote_option" id="votes_1000" name="votes_count" value="1000">
                              <label class="custom-control-label" for="votes_1000">1000 Votes</label>
                              </div>
